    ...
    <Motion.article className="mcq-card" variants={itemVariants} role="group" aria-label={`MCQ ${index}`}> 
      <div className="mcq-header">
        ...
        <div className="mcq-question-text">
          ...
          {mcq.image && <img src={getAssetPath(mcq.image)} alt="Question" className="question-image" loading="lazy" />}
        </div>
      </div>
        ...
        {['A', 'B', 'C', 'D'].map((opt, idx) => (
          ...
          >
            ...
            <div className={textWrapClasses}>
              ...
              {mcq[`option${opt}_img`] && (
                <img src={getAssetPath(mcq[`option${opt}_img`])} alt={`Option ${opt}`} className="option-image" loading="lazy" />
              )}
            </div>
          </button>
        ))}
